...
import com.tidalsolutions.magic89_9.polls.ClosedPollsItems;

/**
 * Created by Jeffrey on 1/7/2016.
 */
public class ClosedPollsAdapter extends android.widget.BaseAdapter{
    private Context context;
    private String[] title_list, date_end_list, poll_choice_id_list;
    private Integer[] id_list, total_votes_list;

    public ClosedPollsAdapter(Context context, Integer[] id_list, String[] title_list, String[] date_end_list, Integer[] total_votes_list, String[] poll_choice_id_list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            v = li.inflate(R.layout.polls_closed_grids, parent, false);
        ...
        btn_top_polls.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, ClosedPollsItems.class);
