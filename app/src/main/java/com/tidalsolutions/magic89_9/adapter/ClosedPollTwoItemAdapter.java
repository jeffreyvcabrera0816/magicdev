 ...
 */
public class ClosedPollTwoItemAdapter extends android.widget.BaseAdapter {
    private AQuery aq;
    ...
    public ClosedPollTwoItemAdapter(Context context, Integer[] id_list, String[] name_list, String[] image_list, Integer[] votes_list, Integer poll_id, String poll_choice_id) {
