 ...
 */
public class TopPollsAdapter extends android.widget.BaseAdapter{
    private Context context;
    private String[] title_list, date_end_list, poll_choice_id_list, countdown_list;
    private Integer[] id_list, total_votes_list;

    public TopPollsAdapter(Context context, Integer[] id_list, String[] title_list, String[] date_end_list, Integer[] total_votes_list, String[] poll_choice_id_list, String[] countdown_list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            v = li.inflate(R.layout.top_polls_list, parent, false);
        ...
        btn_top_polls.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                bundle.putString("poll_choice_id", poll_choice_id_list[position]);
