...
import com.tidalsolutions.magic89_9.adapter.ActivePollsAdapter;
...
public class ActivePollsGrid extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.polls_active);
        setupActionBar();
        ...
        gridView = (GridView) findViewById(R.id.list_active_polls);

        FontUtils.loadFont(ActivePollsGrid.this, "Montserrat-Light.otf");
        FontUtils.setFont(rootLayout);

        new ActivePolls(ActivePollsGrid.this, "/api/polls/open/user/"+UserInfo.getUserID()).execute();
    }
...
//                NavUtils.navigateUpFromSameTask(this);
    ...
    class ActivePolls extends AsyncTask<String, Void, String> {
        Context act;
        ProgressDialog pd;
        String api_url;

        public ActivePolls(Context act, String api_url) {
            this.act = act;
...
//            Toast.makeText(getActivity().getApplicationContext(), result, Toast.LENGTH_LONG).show();
            try {
                ...
                if (status) {
                    ...
                    List<Integer> done_list_arr = new ArrayList<Integer>();
                    ...
                    ActivePollsAdapter activePollsAdapter = new ActivePollsAdapter(act, id_list, title_list, date_end_list, total_votes_list, poll_choice_id_list, countdown_list);
                    gridView.setAdapter(activePollsAdapter);
