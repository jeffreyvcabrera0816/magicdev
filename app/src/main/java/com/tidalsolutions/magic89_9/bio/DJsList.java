 ...
 */
public class DJsList extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new APIDjsList(DJsList.this,  "/api/djs/active").execute();
    }
...
//                NavUtils.navigateUpFromSameTask(this);
    ...
    class APIDjsList extends AsyncTask<String, Void, String> {
        Context act;
        ProgressDialog pd;
        String api_url;

        public APIDjsList(Context act, String api_url) {
            this.act = act;
