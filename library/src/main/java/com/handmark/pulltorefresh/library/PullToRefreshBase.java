...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	 ...
	 * 
	 * @return true if the View is currently in the correct state (for tidalsolutions,
	 ...
	 * 
	 * @return true if the View is currently the correct state (for tidalsolutions, top
	 *         of a ListView)
	 */
